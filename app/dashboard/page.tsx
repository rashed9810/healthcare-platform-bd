    ...
    <ProtectedRoute>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {language === "en" ? "Upcoming Appointments" : "আসন্ন অ্যাপয়েন্টমেন্ট"}
            </CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {language === "en" ? "Scheduled consultations" : "নির্ধারিত পরামর্শ"}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {loading ? <Skeleton className="h-8 w-16" /> : language === "en" ? "Good" : "ভালো"}
            </div>
            <p className="text-xs text-muted-foreground">
              {language === "en" ? "Based on your recent checkups" : "আপনার সাম্প্রতিক পরীক্ষার উপর ভিত্তি করে"}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="appointments" className="space-y-8">
        <TabsList>
          ...
          <TabsTrigger value="prescriptions">
            {language === "en" ? "Recent Prescriptions" : "সাম্প্রতিক প্রেসক্রিপশন"}
          </TabsTrigger>
        </TabsList>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <Button asChild size="sm">
                        <Link href={`/appointments/details/${appointment.id}`}>
                          View Details
                        </Link>
                      </Button>
                    </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">Medication Refill</h3>
                    <p className="text-sm text-muted-foreground">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium">Fever Treatment</h3>
                    <p className="text-sm text-muted-foreground">
                      Dr. Kamal Hossain
                    </p>
                    <p className="text-sm text-muted-foreground mt-1">
